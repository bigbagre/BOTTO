...
- Para instalar mais facilmente as bibliotecas de python, com o python 3.13 basta primeiro escrever no terminal: ```.venv/Scripts/activate```, para poder entrar na venv, apartir dai vc so escreve  ```pip install -r requirements.txt```
...
- [http://100.123.51.17:5000/teste](http://100.123.51.17:5000/teste) - Abre o banco de dados e informa os comandos para enviar e buscar os dados
...
[{'Nome': 'Sensor1', 'Valor': 15, 'criado_em': '2026-09-20 14:17:16', 'id': 1}]`
 ```
- Se aparecer isso, coloca no seu navegador: [http://100.123.51.17:5000/teste](http://100.123.51.17:5000/teste) e lá deve aparecer os seus valores